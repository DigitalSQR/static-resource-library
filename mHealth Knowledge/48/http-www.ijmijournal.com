...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="PHz2qsKd53oZfX4JAAZMNN3WhPYJ7miJiF4ar4k58ycQI8AEfCIGiU7CaOjV7pdj4Axuu5CGv+mhv88a9ddQ45ky8FIQufbREBRwCcS/xPM=" />
</div>
		                        ...
		                        <div id="content">
			                        <div class="errorBoard">
                                        <div class="siteMaintenance" style="font-family:Tahoma">
                                            <h1>ijmijournal.com<br /> is coming soon</h1>
                                        </div>
                                    </div>                                
		                        </div>                            
                            </div>
